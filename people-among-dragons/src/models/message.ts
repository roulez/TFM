export class Message {
    ...
    constructor(messageId: number, messageTitle: string, messageText: string, sendingUserName: string, sendingUserSurname: string, sendingUserEmail: string, receivingUserName: string, receivingUserSurname: string, receivingUserEmail: string, creationDate: Date){
